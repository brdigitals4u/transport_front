...
import { useMenus } from "../hooks/useRoleMenu";
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    if (!navItems.length) return; // Ensure menus are available
  ...
  }, [location.pathname, navItems]); // Ensure it runs when API data updates
